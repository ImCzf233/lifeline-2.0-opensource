package Lifeline.wtf.gui.notification;
...
public class NoticeNotification {
    ...
    public NoticeNotification(final String header, final String message, final Type type, final long stayTime) {
        this.message = message;
        this.header = header;
        (this.timer = new TimeHelper()).reset();
        this.width = mc.fontRendererObj.getStringWidth(message);
        this.height = 10.5;
        this.animationX = this.width;
        this.imageWidth = 20;
        this.posY = -1.0;
    ...
    public static void send(String header,String message, Type type, long stayTime) {
        ...
        notifications.add(new NoticeNotification(header,message, type, stayTime));
    }
