...
import Lifeline.wtf.utils.render.ColorUtils;
...
//        Client.musicPanel.render(mouseX,mouseY);
        ...
        RenderUtil.drawRoundedRect2
                ...
                (windowX, windowY, windowX + width, windowY + height, 4, theme.BG.getRGB());
        if (selectMod == null) {
            FontLoaders.Jello20.drawString(Client.name + " " + Client.version, windowX + 15, windowY + height - 20, theme.FONT.getRGB());
        }
        //绘制顶部图标
...
//                    RenderUtil.drawCustomImageAlpha(typeXAnim[i], windowY + 10, 16, 16, new ResourceLocation("client/" + e.name() + ".png"), theme.FONT_C.getRGB(),255);
                    FontLoaders.J18.drawString(e.name(), typeXAnim[i] + 20, windowY + 15, theme.FONT_C.getRGB());
                    typeX += (32 + FontLoaders.J18.getStringWidth(e.name() + " "));
                } else {
...
//            }
        ...
        if (selectType == ClickType.Home) {
            if (selectMod == null) {
                ...
                for (Category m : Category.values()) {
                    if (m == modCategory) {
                        ...
                        RenderUtil.drawRoundedRect2
                                ...
                                (windowX + 7, hy - 8, windowX + 90, hy + FontLoaders.J18.getStringHeight("") + 6, 0.15f, ColorUtils.reAlpha(theme.BG_4.getRGB(), 0.1f));
                        RenderUtil.drawRoundedRect2
                                ...
                                (windowX + 7, hy - 2, windowX + 9, hy + FontLoaders.J18.getStringHeight(""), 0.15f, theme.BG_3);

                        FontLoaders.J18.drawString(m.name(), windowX + 20, cateY, theme.FONT_C.getRGB());
                        ...
                        FontLoaders.J18.drawString(m.name(), windowX + 20, cateY, theme.FONT.getRGB());
                    }
                ...
                RenderUtil.drawCustomImage(windowX + 10, windowY + height - 64, 20, 20, new ResourceLocation("ETB/POR.jpg"));

                FontLoaders.J18.drawString(Minecraft.thePlayer.getName(), windowX + 35, windowY + height - 60, theme.FONT_C.getRGB());
                FontLoaders.J18.drawString("LIFELINE DEVS", windowX + 35, windowY + height - 50, theme.FONT.getRGB());
            ...
            if (selectMod != null) {
                ...
                RenderUtil.drawRoundedRect2
                        ...
                        (windowX + 430 + valuemodx, windowY + 60, windowX + width, windowY + height - 20, 3, theme.Modules.getRGB());
                ...
                RenderUtil.drawRoundedRect2
                        ...
                        (windowX + 430 + valuemodx, windowY + 60, windowX + width, windowY + 85, 3, theme.Modules_C);
                ...
                FontLoaders.J18.drawString(modCategory.name() + " > " + selectMod.name, windowX + 460 + valuemodx, windowY + 70, theme.FONT.getRGB());
                RenderUtil.drawCustomImage(windowX + 440 + valuemodx, windowY + 68, 8, 8, new ResourceLocation("ETB/back.png"), theme.FONT_C.getRGB());
                ...
                if (selectMod.values.size() == 0) {
                    FontLoaders.J18.drawString("No Settings here", windowX + 445 + valuemodx, valuey + 4, theme.FONT_C.getRGB());
                }
                    ...
                    if (v instanceof Option) {
                        if (valuey + 4 > windowY + 100) {
                            if (((Boolean) v.getValue())) {
                                FontLoaders.J18.drawString(v.getName(), windowX + 445 + valuemodx, valuey + 4, theme.FONT_C.getRGB());
                                v.optionAnim = 100;
                                RenderUtil.drawRoundedRect2
                                        ...
                                        (windowX + width - 30, valuey + 2, windowX + width - 10, valuey + 12, 4, ColorUtils.reAlpha(new Color(33, 94, 181).getRGB(), (v.optionAnimNow / 100f)));
                                RenderUtil.smoothCircle(windowX + width - 25 + 10 * (v.optionAnimNow / 100f), valuey + 7, 3.5f, new Color(255, 255, 255).getRGB());
                            } else {
                                FontLoaders.J18.drawString(v.getName(), windowX + 445 + valuemodx, valuey + 4, theme.FONT.getRGB());
                                v.optionAnim = 0;
//                                RenderUtil.drawRoundedRect2
//
//
...
//
//
//                          (windowX + width - 30, valuey + 2, windowX + width - 10, valuey + 12, 4,new Color(59, 60, 65).getRGB());
                                RenderUtil.drawRoundedRect2
                                        ...
                                        (windowX + width - 30, valuey + 2, windowX + width - 10, valuey + 12, 4, theme.Option_U_B);
                ...
                for (Value v : selectMod.values) {
                    if (v instanceof Numbers) {
                        if (valuey + 4 > windowY + 100) {
                            ...
                            FontLoaders.J18.drawString(v.getName(), windowX + 445 + valuemodx, valuey + 5, theme.FONT.getRGB());
                            FontLoaders.J18.drawCenteredString(v.getValue().toString(), windowX + width - 20, valuey + 5, theme.FONT_C.getRGB());
                            RenderUtil.drawRect2(windowX + 450 + valuemodx, valuey + 20, windowX + width - 11, valuey + 21.5f, new Color(16, 16, 16).getRGB());
                            RenderUtil.drawRect2(windowX + 450 + valuemodx, valuey + 20, windowX + 450 + valuemodx + present, valuey + 21.5f, new Color(16, 16, 16).getRGB());
                    ...
                    if (v instanceof Mode) {
                        ...
                        if (valuey + 4 > windowY + 100 & valuey < (windowY + height)) {
                            RenderUtil.drawRoundedRect2
                                    ...
                                    (windowX + 445 + valuemodx, valuey + 2, windowX + width - 5, valuey + 22, 4, theme.BG_4);
                            RenderUtil.drawRoundedRect2
                                    ...
                                    (windowX + 446 + valuemodx, valuey + 3, windowX + width - 6, valuey + 21, 4, theme.BG);
                            FontLoaders.J18.drawString(v.getName() + ":" + modeValue.getModeAsString(), windowX + 455 + valuemodx, valuey + 10, theme.FONT.getRGB());
                            FontLoaders.J18.drawString(">", windowX + width - 15, valuey + 9, theme.FONT_C.getRGB());
...
//
//
//                  (windowX + 445 + valuemodx, valuey + 2, windowX + width - 5, valuey + 22, 2, new Color(46, 45, 48).getRGB());
//                        RenderUtil.drawRoundedRect2
//
//
//
...
//
//
//                  (windowX + 446 + valuemodx, valuey + 3, windowX + width - 6, valuey + 21, 2, new Color(32, 31, 35).getRGB());
...
//
//
//                  (windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25,4, new Color(43, 41, 45).getRGB());
//                    } else {
//                        RenderUtil.drawRoundedRect2
//
//
...
//
//
//                  (windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, 4,new Color(35, 35, 35).getRGB());
//                    }
//                } else {
                if (m.isEnabled()) {
//                    RenderUtil.drawRoundedRect2
...
//
//
//              (windowX + 99.9f + valuemodx, modY - 10.1f, windowX + 425.1f + valuemodx, modY + 25.1f, 4, theme.BG_2);
                    RenderUtil.drawRoundedRect2
                            ...
                            (windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, 4, theme.Modules_C);
                } else {
//                    RenderUtil.drawRoundedRect2
//
//
...
//              (windowX + 99.9f + valuemodx, modY - 10.1f, windowX + 425.1f + valuemodx, modY + 25.1f, 4, theme.BG_2);
                    RenderUtil.drawRoundedRect2
                            ...
                            (windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, 4, theme.Modules);
...
//                }
                ...
                RenderUtil.drawRoundedRect2
                        ...
                        (windowX + 410 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, 4, theme.BG_4);
                FontLoaders.J18.drawString(".", windowX + 416 + valuemodx, modY - 5, theme.FONT.getRGB());
                FontLoaders.J18.drawString(".", windowX + 416 + valuemodx, modY - 1, theme.FONT.getRGB());
                FontLoaders.J18.drawString(".", windowX + 416 + valuemodx, modY + 3, theme.FONT.getRGB());

                if (isHovered(windowX + 100 + valuemodx, modY - 10, windowX + 425 + valuemodx, modY + 25, mouseX, mouseY) || m.isEnabled()) {
                    FontLoaders.J18.drawString(m.getName(), windowX + 141 + valuemodx, modY + 5, theme.FONT_C.getRGB());
                } else {
                    FontLoaders.J18.drawString(m.getName(), windowX + 140 + valuemodx, modY + 5, theme.FONT.getRGB());
                }

                FontLoaders.J18.drawString(m.getDescription(), windowX + 220 + valuemodx, modY + 5, theme.FONT.getRGB());
                ...
                if (m.isEnabled()) {
                    RenderUtil.drawRoundedRect2
                            ...
                            (windowX + 100 + valuemodx, modY - 10, windowX + 125 + valuemodx, modY + 25, 4, ColorUtils.reAlpha(theme.BG_3.getRGB(), (m.optionAnimNow / 100f)));
                    RenderUtil.drawCustomImage(windowX + 105 + valuemodx, modY, 16, 16, new ResourceLocation("ETB/module.png"), new Color(220, 220, 220).getRGB());
                    m.optionAnim = 100;
                    ...
                    RenderUtil.drawRoundedRect2
                            ...
                            (windowX + 380 + valuemodx, modY + 2, windowX + 400 + valuemodx, modY + 12, 4, ColorUtils.reAlpha(theme.Option_B.getRGB(), m.optionAnimNow / 100f));
                    ...
                    RenderUtil.drawRoundedRect2
                            ...
                            (windowX + 100 + valuemodx, modY - 10, windowX + 125 + valuemodx, modY + 25, 4, theme.BG_2);
                    RenderUtil.drawCustomImage(windowX + 105 + valuemodx, modY, 16, 16, new ResourceLocation("ETB/module.png"), theme.BG_4.getRGB());
                    m.optionAnim = 0;
                    ...
                    RenderUtil.drawRoundedRect2
                            ...
                            (windowX + 380 + valuemodx, modY + 2, windowX + 400 + valuemodx, modY + 12, 4, theme.BG_2);
//                    RenderUtil.drawRoundedRect2
//
//
//
...
//
//
//              (windowX + 381 + valuemodx, modY + 3, windowX + 399 + valuemodx, modY + 11, 4, new Color(29, 27, 31).getRGB());
...
//
//
//      (windowX + 20, windowY + FontLoaders.arial18.getStringHeight("") + 62, windowX + 30, windowY + FontLoaders.arial18.getStringHeight("") + 64, 0, new Color(51, 112, 203).getRGB());
//
//
...
//
//
//      (windowX + 20, windowY + 110, windowX + 105, windowY + 111, 0, new Color(36, 36, 40).getRGB());
...
//
//
//          (cx, cy, cx + 100, cy + 100, 2, theme.BG_4);
//
...
//
//
//              (cx + 65, cy + 75, cx + 90, cy + 90, 2, theme.BG_2);
//                } else {
//                    RenderUtil.drawRoundedRect2
//
//
...
//
//
//              (cx + 65, cy + 75, cx + 90, cy + 90, 2, theme.BG_3);
//                }
...
//        Client.musicPanel.onMouse(mouseX,mouseY,mouseButton);
        ...
        for (Enum<?> e : ClickType.values()) {
            if (e != ClickType.Settings) {
                if (e == selectType) {
                    if (isHovered(typeX, windowY + 10, typeX + 16 + FontLoaders.J18.getStringWidth(e.name() + " "), windowY + 10 + 16, mouseX, mouseY)) {
        ...
        if (selectType == ClickType.Home) {
            ...
            for (Category m : Category.values()) {
                ...
                if (isHovered(windowX, cateY - 8, windowX + 50, cateY + FontLoaders.J18.getStringHeight("") + 8, mouseX, mouseY)) {
                    if (modCategory != m) {
                        modsRole = 0;
                    }
