...
import Lifeline.wtf.utils.render.Translate;
   ...
   public void setEnabled(boolean enabled) {
      ...
      if(enabled) {
         ...
         if (Minecraft.theWorld != null) {
             ...
             NotificationManager.show(new Notification(NotificationType.INFO, "Module Information", "Enabled " + this.getName(), 2));
         }
    	  ...
    	  if (Minecraft.theWorld != null) {
              Minecraft.thePlayer.playSound("random.click", 0.2f, this.enabled ? 0.6f : 0.5f);
              NotificationManager.show(new Notification(NotificationType.ERROR, "Module Information", "Disabled " + this.getName(), 2));
          }
