...
import Lifeline.wtf.utils.ShaderUtil;
...
public class GradientUtil implements Utils {
    ...
    private static final Lifeline.wtf.utils.ShaderUtil gradientMaskShader = new Lifeline.wtf.utils.ShaderUtil("Tenacity/Shaders/gradientMask.frag");
    private static final Lifeline.wtf.utils.ShaderUtil gradientShader = new Lifeline.wtf.utils.ShaderUtil("Tenacity/Shaders/gradient.frag");
