...
import Lifeline.wtf.events.rendering.EventDrawText;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Client.instance.getNotificationManager().drawNotifications(scaledresolution);
    ...
    {
        Lifeline.wtf.module.modules.visual.Scoreboard scoreboard23 = (Lifeline.wtf.module.modules.visual.Scoreboard) Client.instance.getModuleManager().getModuleByClass(Lifeline.wtf.module.modules.visual.Scoreboard.class);
        ...
        for (Object score1 : arraylist1) {
            ...
            if (scoreboard23.serverip.getValue()) {
                if (s1.contains("mc.remiaft.com") ||
                    ...
                    if (Lifeline.wtf.module.modules.visual.Scoreboard.serveripm.getValue() == Lifeline.wtf.module.modules.visual.Scoreboard.serverIPMode.Normal) {
                        s1 = EnumChatFormatting.RED + "LIFELINE" + ".wtf";
                    } else {
                        s1 = "LIFELINE.wtf";
                ...
                if (s1.contains("mc.loyisa.cn")) {
                    if (Lifeline.wtf.module.modules.visual.Scoreboard.serveripm.getValue() == Lifeline.wtf.module.modules.visual.Scoreboard.serverIPMode.Normal) {
                        s1 = EnumChatFormatting.AQUA + "LIFELINE " + EnumChatFormatting.BLUE + ".wtf";
                    } else {
                        s1 = "Loyisa Test";
                    }
            ...
            if (Lifeline.wtf.module.modules.visual.Scoreboard.serveripm.getValue() == Lifeline.wtf.module.modules.visual.Scoreboard.serverIPMode.Rainbow) {
                this.getFontRenderer().drawString(s1, j, l, ColorUtils.fastrainbow().getRGB());
            }
            else {
