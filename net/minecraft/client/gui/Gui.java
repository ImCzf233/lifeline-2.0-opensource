...
import Lifeline.wtf.utils.render.GLUtil;
...
public class Gui
{
    ...
    public static void drawFloatRect(double left, double top, double d, double bottom, int color) {
        ...
        var10.addVertex(d, bottom, 0.0);
        var10.addVertex(d, top, 0.0);
    ...
    public static void drawModalRectWithCustomSizedTexture1(float f, double d, float u, float v, double h, double e, double i, double g) {
        double var8 = 1.0 / i;
        double var9 = 1.0 / g;
        Tessellator var10 = Tessellator.getInstance();
        WorldRenderer var11 = var10.getWorldRenderer();
        var11.startDrawingQuads();
        var11.addVertexWithUV((double)f, d + e, 0.0, (double)u * var8, (double)(v + (float)e) * var9);
        var11.addVertexWithUV((double)f + h, d + e, 0.0, (double)(u + (float)h) * var8, (double)(v + (float)e) * var9);
        var11.addVertexWithUV((double)f + h, d, 0.0, (double)(u + (float)h) * var8, (double)v * var9);
        var11.addVertexWithUV((double)f, d, 0.0, (double)u * var8, (double)v * var9);
        var10.draw();
    }
